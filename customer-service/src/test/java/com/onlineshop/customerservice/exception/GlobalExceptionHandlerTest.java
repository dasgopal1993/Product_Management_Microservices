...
public class GlobalExceptionHandlerTest {
    ...
    public void testHandleGlobalException() {
        ...
        Exception exception = new Exception("An error occurred while processing the request. Please try again later.");
        ...
        assertEquals("An error occurred while processing the request. Please try again later.", errorDetails.getMessage());
